...
async function checkNote() {
    try {
        const id = '6a4ef54e44adc7c285852853';
        const companyId = '84d1586e-5d0c-456f-aa12-aefc5a9364a7'; // SERVICE LINE
        ...
        try {
            ...
            console.log('✅ National Status Response:', res.data);
        } catch (err: any) {
        ...
        try {
            ...
            console.log('✅ Municipal Status Response:', res.data);
        } catch (err: any) {
