                                                    ...
                                                    <div className="flex justify-between items-start w-full gap-4">
                                                        ...
                                                        <div className="flex flex-col min-w-0">
                                                            <span className="text-[9px] text-gray-400 dark:text-slate-500 font-bold flex items-center gap-0.5 uppercase tracking-wider select-none">
                                                                Cidade <Info size={10} className="text-gray-450 dark:text-slate-500 shrink-0" />
                                                            </span>
...
const divStartIdx = content.indexOf("<div \n                                                key={city.id}", returnIdx);
...
const originalCardBlockStart = content.substring(divStartIdx, divStartIdx + 3000); // margem grande
const closingDivIdx = originalCardBlockStart.indexOf('                                            </div>\n                                        );');
...
const originalModalCard = originalCardBlockStart.substring(0, closingDivIdx + '                                            </div>'.length);
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <div className="flex justify-between items-start gap-4">
                                                        ...
                                                        {/* Status Badge */}
                                                        {status?.loading ? (
                                                            <span className="inline-flex items-center gap-1 text-[8px] font-extrabold text-indigo-650 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-955 px-1.5 py-0.5 rounded-md border border-indigo-100/30 shrink-0">
