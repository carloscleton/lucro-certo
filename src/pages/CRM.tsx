...
export function CRM() {
    const { stages, deals, loading, deleteStage, deleteDeal } = useCRM();
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex gap-4 overflow-x-auto pb-6 items-start min-h-[calc(100vh-250px)] scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-slate-700">
                {stages.map(stage => (
                    <div key={stage.id} className="flex-shrink-0 w-80 bg-gray-50/50 dark:bg-slate-900/40 rounded-2xl p-4 flex flex-col gap-4 border border-gray-100 dark:border-slate-800/50">
