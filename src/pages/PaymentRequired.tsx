        ...
        <div className="min-h-screen bg-[#070b14] text-white selection:bg-blue-500/30 overflow-x-hidden font-sans">
            ...
            <div className="fixed inset-0 z-0">
                <img 
                    ...
                    alt="" 
                    className="w-full h-full object-cover opacity-[0.4] scale-105 blur-[2px]"
                />
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 lg:py-16">
                ...
                <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <p className="text-slate-400 text-sm md:text-lg max-w-xl mx-auto font-medium leading-relaxed">
                        Escolha o plano ideal e libere toda a inteligência financeira do sistema.
                    </p>
                </div>
                        ...
                        <div 
                            ...
                            className={`relative cursor-pointer rounded-[1.5rem] p-6 border transition-all duration-300 flex flex-col group ${
                                selectedPlan?.name === plan.name 
                                    ? 'bg-blue-600/10 border-blue-500 shadow-[0_15px_30px_-10px_rgba(59,130,246,0.3)] ring-1 ring-blue-500/20' 
                                    : 'bg-white/[0.03] border-white/5 hover:border-white/10 hover:bg-white/[0.05]'
                            }`}
                        >
                            {plan.is_popular && (
                                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-[8px] font-black px-3 py-1 rounded-full uppercase tracking-widest shadow-lg">
                                    Popular
                                </div>
                            )}
                ...
                <div className="max-w-2xl mx-auto">
                    <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[1.5rem] border border-white/10 p-8 md:p-10 shadow-xl">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h4 className="text-base font-bold text-white tracking-tight italic">Dados de Faturamento</h4>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#0a0f1a] border ${errorMsg ? 'border-red-500/40' : 'border-white/5'} rounded-xl p-3 text-white placeholder:text-slate-800 focus:border-blue-500/30 transition-all outline-none text-sm`}
                                />
                                {errorMsg && <p className="text-red-500 text-[9px] font-bold uppercase tracking-tight">{errorMsg}</p>}
                            </div>
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#0a0f1a] border ${phoneError ? 'border-red-500/40' : 'border-white/5'} rounded-xl p-3 text-white placeholder:text-slate-800 focus:border-blue-500/30 transition-all outline-none text-sm`}
                                />
                                {phoneError && <p className="text-red-500 text-[9px] font-bold uppercase tracking-tight">{phoneError}</p>}
                            </div>
                        </div>
                        ...
                        <Button
                            ...
                            isLoading={loading}
                            className="w-full h-16 rounded-xl text-lg font-black bg-gradient-to-r from-blue-600 to-emerald-600 hover:scale-[1.01] transition-all duration-300 flex items-center justify-center gap-3 group"
                        >
                            <CreditCard size={20} className="group-hover:scale-110 transition-transform" />
                            ASSINAR AGORA
                        </Button>

                        <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4 pt-6 border-t border-white/5">
                            <div className="flex items-center gap-2 text-slate-500 text-[10px] font-bold uppercase tracking-tight">
                                <AlertTriangle size={14} className="text-amber-500" />
                                Gateway Seguro via Asaas®
                            </div>
                            <button
