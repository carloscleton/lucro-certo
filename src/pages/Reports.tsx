                        ...
                        {isMounted && expenseData.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                                <PieChart>
                                    ...
                                    <RechartsTooltip formatter={(value: any) => [`${window.__CURRENCY_SYMBOL__ || `${window.__CURRENCY_SYMBOL__ || "R$"}`} ${typeof value === 'number' ? value.toFixed(2) : '0.00'}`, 'Valor']} />
                                    <Legend />
                                </PieChart>
                            </ResponsiveContainer>
                        ) : (
                        ...
                        {isMounted && expensePendingData.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                                <PieChart>
                                    ...
                                    <RechartsTooltip formatter={(value: any) => [`${window.__CURRENCY_SYMBOL__ || `${window.__CURRENCY_SYMBOL__ || "R$"}`} ${typeof value === 'number' ? value.toFixed(2) : '0.00'}`, 'Pendente']} />
                                    <Legend />
                                </PieChart>
                            </ResponsiveContainer>
                        ) : (
