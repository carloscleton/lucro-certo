...
<body style="margin:0;padding:0;background-color:#f8fafc;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* Toggle content type */}
      <div className="flex items-center gap-4 bg-white dark:bg-slate-800 p-2.5 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-md self-start">
        <button
          type="button"
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        {/* Lado Esquerdo: Editor HTML ou Uploader de Flyer */}
        {contentType === "html" ? (
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-[2.5rem] border border-gray-100 dark:border-slate-700 shadow-xl shadow-gray-150/30 dark:shadow-none space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter">
                  Imagem / Flyer Promocional
                </h3>
                <p className="text-xs text-gray-500 font-medium">
                  Envie um banner ou panfleto pronto para a sua campanha
                </p>
              </div>
