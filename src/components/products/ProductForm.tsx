        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <CurrencyInput
                        label={`Preço Unitário (${window.__CURRENCY_SYMBOL__ || `${window.__CURRENCY_SYMBOL__ || "R$"}`}) *`}
                        value={price}
                ...
                {isFiscalEnabled && (
                    <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-700 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <CurrencyInput
                                label={`Preço de Custo (${window.__CURRENCY_SYMBOL__ || `${window.__CURRENCY_SYMBOL__ || "R$"}`})`}
                                value={costPrice}
