    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 transition-colors">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white">{t('dashboard.dashboard_360')}</h3>
                    <p className="text-xs text-gray-500 dark:text-gray-400">{t('dashboard.sales_vs_finance')}</p>
                </div>
            ...
            <div className="space-y-4">
                ...
                <div className="relative overflow-hidden p-4 rounded-xl border border-gray-100 dark:border-slate-700 bg-gray-50/50 dark:bg-slate-900/30">
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">{t('dashboard.active_pipeline')}</span>
                    </div>
                    ...
                    <p className="text-[10px] text-gray-500 mt-1">
                        {activeDeals.length === 1 
                            ? t('dashboard.pipeline_summary', { count: activeDeals.length }) 
                            : t('dashboard.pipeline_summary_plural', { count: activeDeals.length })}
                    </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 rounded-xl border border-emerald-100 dark:border-emerald-900/30 bg-emerald-50/30 dark:bg-emerald-900/10">
                        <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase">{t('dashboard.received_actual')}</span>
                    ...
                    <div className="p-3 rounded-xl border border-blue-100 dark:border-blue-900/30 bg-blue-50/30 dark:bg-blue-900/10">
                        <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase">{t('dashboard.weighted_forecast')}</span>
                ...
                <div className="pt-2">
                    <div className="flex justify-between text-[11px] mb-1.5">
                        <span className="text-gray-500 dark:text-gray-400 font-medium">{t('dashboard.avg_closing_probability')}</span>
