-- FIX POSTAGENS IA IA IA (Marketing Config)
-- Update admin_update_company_config to include has_social_copilot

DROP FUNCTION IF EXISTS public.admin_update_company_config(UUID, BOOLEAN, BOOLEAN, BOOLEAN, JSONB);
DROP FUNCTION IF EXISTS public.admin_update_company_config(UUID, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, JSONB);
...
-- Update get_admin_companies_list to return has_social_copilot
