-- Update create_company RPC to support PF/PJ entity types
DROP FUNCTION IF EXISTS public.create_company(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
...
BEGIN
    ...
    INSERT INTO public.companies (
        ...
        city,
        state,
        allowed_entity_types -- Inherit PF/PJ allowed types from default
    )
    VALUES (
        name_input, 
        trade_name_input, 
        ...
        city_input,
        state_input,
        ARRAY['PF', 'PJ'] -- By default new companies can have both, but this is usually controlled by the platform admin
    )
